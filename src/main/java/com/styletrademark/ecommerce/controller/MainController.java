...
import com.styletrademark.ecommerce.service.MyService;
...
public class MainController {
	...
	public String addProduct(@ModelAttribute Product product, @RequestParam MultipartFile image1,@RequestParam MultipartFile image2,@RequestParam MultipartFile image3, HttpSession session)
			throws IOException {
		return service.addProduct(product, image1,image2,image3, session);
	}
	...
	public String editProduct(@ModelAttribute Product product, @RequestParam("image1") MultipartFile image1,
            @RequestParam("image2") MultipartFile image2,
            @RequestParam("image3") MultipartFile image3,
           HttpSession session)
			throws IOException {
		return service.editProduct(product,image1,image2,image3, session);
	}
	...
	public String QuickView(@PathVariable int id,HttpSession session,ModelMap map) {
		return service.QuickView(id,map);
	}
